return {
	...
	hud_cam_access_camera_crojob2_office = "Office",
	...
	hud_cam_access_camera_staircase = "Staircase",
	...
	hud_e_election_day_stage1new_mission3_hl = "Escape!",
	...
	hud_e_election_day_stage2new_mission5_hl = "Escape!",
	...
	hud_heist_dinner_attack_convoy = "Attack and halt the convoy!",
	...
	hud_heist_dinner_drill = "Drill open the safe.",
	hud_heist_dinner_drill_hl = "Drill the safe",
	...
	hud_heist_dinner_load_gold = "Use the crane to lift the container containing the gold onto the truck.",
	...
	hud_heist_flat_bag = "Alex dropped off the C4 bag, find it.",
	hud_heist_flat_bag_hl = "Locate the C4 Bag",
	hud_heist_flat_c4 = "Place the C4 charges on the roof, floor 4 and 5.",
	hud_heist_flat_c42 = "Move downstairs, away from the C4!",
	hud_heist_flat_c42_hl = "Move away from the C4!",
	hud_heist_flat_c4_hl = "Place the C4 charges",
	hud_heist_flat_detach = "Saw off the beams above and below the panic room to detach it from the floor.",
	hud_heist_flat_detach2 = "Hold the fort and keep an eye on the saws.",
	hud_heist_flat_detach2_hl = "Keep the saws going",
	hud_heist_flat_detach_hl = "Setup the saws",
	hud_heist_flat_door = "The panic room should be in a flat on the third floor.",
	...
	hud_heist_flat_escape = "Get downstairs to the basement and escape through the sewers.",
	hud_heist_flat_escape_hl = "Escape is available",
	hud_heist_flat_intro = "Let Chavez buzz you in, and then enter the building through the back door.",
	hud_heist_flat_intro_hl = "Enter the building",
	hud_heist_flat_key = "Locate Chavez - he is on one of the upper floors in the building, wearing a red beanie hat. Take the key from him.",
	...
	hud_heist_flat_panic = "Use the key to open the red door.",
	...
	hud_heist_flat_snipes = "Take out all snipers on the rooftops around the building so that the helicopter can drop off the C4.",
	hud_heist_flat_snipes_hl = "Take out the snipers",
	hud_heist_flat_start = "Go through with the drug deal. This is the front that allows us to enter the building.",
	hud_heist_flat_start_hl = "Go through with the drug deal",
	hud_heist_flat_wait = "Wait for the helicopter to drop the C4 on the roof.",
	hud_heist_flat_wait2 = "Hold the fort until the helicopter returns to lift the panic room.",
	hud_heist_flat_wait2_hl = "Wait for the helicopter to return",
	hud_heist_flat_wait_hl = "Wait for the explosives",
	hud_heist_flat_winch = "Attach the magnet hanging from the helicopter to the top of the panic room.",
	...
	hud_heist_man11 = "Make the escape, a helicopter will pick you up on the neighbouring rooftop.",
	...
	hud_heist_man4 = "Shoot at the cables snagging the limo to make it fall!",
	...
	hud_heist_man6 = "We need to get the Taxman to the transfer room we started out in. Use all necessary force to make him cooperate.",
	...
	hud_heist_mia_mission11_hl = "Escape!",
	...
	hud_heist_pal10 = "Attach the C4 to the safe using the hole you just drilled. Let the water and explosion force the safe open from within!",
	hud_heist_pal10_hl = "Attach the C4 to the safe",
	hud_heist_pal11 = "Take the printing plates from within the safe.",
	...
	hud_heist_pal2 = "Get access to the secret criminal enterprise under Mitchell's pool.",
	hud_heist_pal2_hl = "Hack the code locks",
	hud_heist_pal3 = "Get down under the pool and into the printing shelter.",
	...
	hud_heist_pal5 = "Apply the drill to the safe and plug the power cord into an outlet. As soon as the drill is done, drag the water hose down to the basement and connect it.",
	hud_heist_pal5_hl = "Drill a hole and connect the hose to the safe",
	hud_heist_pal6 = "See to it that the drill finishes it's job. The cops might try to turn the power off.",
	hud_heist_pal6_hl = "Let the drill finish",
	hud_heist_pal7 = "Connect the rest of the hose to the hole in the safe.",
	hud_heist_pal7_hl = "Connect the hose to the safe",
	hud_heist_pal8 = "Go up to the tap and make sure the water is flowing.",
	hud_heist_pal8_hl = "Get the water running",
	hud_heist_pal9 = "Cops might try to cut the water supply. Make sure the water is flowing!",
	...
	hud_heist_red2_mission1 = "Get inside and don't draw attention to yourselves!",
	...
	hud_heist_red2_mission12 = "Apply C4 to the wall next to the server room and blow a hole into the neighboring building.",
	...
	hud_heist_red2_mission4 = "Mount the drill on the gate outside the vault area.",
	hud_heist_red2_mission4_hl = "Start the drill",
	hud_heist_red2_mission5 = "Keep an eye on the drill - it jams.",
	...
	hud_heist_short2_stage1_06_hl = "Drill the safe",
	...
	hud_heist_shoutout_raid7_hl = "Escape!",
	...
	mission_glace_1 = "Make your way further along the bridge and locate the prison convoy.",
	mission_glace_1_hl = "Locate the prison convoy",
	mission_glace_2 = "Locate the prisoner! He's in one of the trucks. Saw the doors open.",
	mission_glace_2_hl = "Find The Prisoner",
	mission_glace_3 = "Escort the prisoner to the top of the right tower. When he's at the top, strap him down in the chair and send him skyward with the balloon.",
	...
	mission_glace_5 = "Send up the Balloon so George can fly in and pick up the Ejection Seat.",
	mission_glace_5_hl = "Send up the balloon",
	mission_glace_6 = "Make it to the Bridge Pillar and take the stairs to the waiting scuba gear.",
	mission_glace_6_hl = "Make for the escape",
	mission_glace_identify = "Send up the Balloon so George can fly in and pick up the Ejection Seat.",
