...
if(UALocGlobal.Options:GetValue("Compatibility/HopLibShouldBeInPortuguese")) then
    PD2PTBR = true
end

-- BeardLib force Brazilian
if(UALocGlobal.Options:GetValue("Compatibility/BeardLibShouldBeInPortuguese")) then
    LocalizationModule.forced_language = "portuguese"
end

-- BRL Currency
if(UALocGlobal.Options:GetValue("Extras/BRLCurrency")) then
...
if(UALocGlobal.Options:GetValue("Extras/AprilFools2022")) then
