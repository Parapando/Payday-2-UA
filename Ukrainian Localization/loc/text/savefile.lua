Hooks:Add("LocalizationManagerPostInit", "UK_savefile", function(loc) 
	...
	savefile_progress = "Ігрова прогресія: Потрібна Версія $VERSION; або пізніша.",
	savefile_progress_description = "Статистика гравця та ігрова прогресія.",
	savefile_removing = "Видалення...",
